...
$t['Share Info'] = "分享信息";
$t['Share Video'] = "分享视频";
$t['Show _MENU_ entries'] = "显示 _MENU_ 项";
$t['Show Less'] = "显示更少";
$t['Show More'] = "显示更多";
$t['Showing _START_ to _END_ of _TOTAL_ entries'] = "显示 _START_ 到 _END_ 总 _TOTAL_ 项";
$t['Showing {{ctx.start}} to {{ctx.end}} of {{ctx.total}} entries'] = "显示 {{ctx.start}} 到 {{ctx.end}} 总 {{ctx.total}} 项";
$t['Showing 0 to 0 of 0 entries'] = "显示 0 到 0 总 0 项";
$t['Sign in'] = "登录";
$t['Sign In'] = "登录";
$t['Sign in now!'] = "立即登录!";
...
$t['You already report this video'] = "您已经举报过该视频";
